    ...
    <nav>
        <ul>
            ...
            <?php if (isset($_SESSION['admin']) && !empty($_SESSION['admin'])): ?>
                ...
                <li><a class="logoutbtn traductor" href="/Reto5-Michis/logout.php" data-es="Cerrar Sesión" data-ca="Tancar Sessió"></a></li>
            <?php else: ?>
                <li><a href="/Reto5-Michis/login.php" class="btn-login traductor" data-es="Admin Login" data-ca="Admin Login"></a></li>
            <?php endif; ?>
        </ul>
    </nav>
</header>
